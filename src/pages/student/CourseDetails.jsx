...
const CourseDetails = () => {
  ...
  const { allCourses, calculateRating,
    currency, calculateNoOfLectures,
  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='absolute top-0 left-0 w-full h-section-height z-0 bg-gradient-to-b from-cyan-100/70 to-transparent'></div>

        {/* left column  */}

        <div className='max-w-xl z-10 text-gray-500'>

          <h1 className='md:text-course-deatils-heading-large text-course-details-heading-small font-semibold text-gray-800'>{courseData.courseTitle}</h1>
          ...
          <p>Course by  <span className='text-blue-600 underline'>BukkaBaba</span></p>
          ...
          <div className='py-20 text-sm md:text-default'>
            <h3 className='text-xl font-semibold text-gray-800'>Course Desccription</h3>
